...
export class UpdatePoComponent implements OnInit {
 ...
 @ViewChild('content') content:ElementRef;
  ...
  constructor(private dialog : MatDialog  ,private interactionService :InteractionService,private _vendorService: VendorService, private _PurchaseOrder:PurchaseOrder,private formBuilder: FormBuilder ,private router: Router,private routerx: ActivatedRoute) { }

  ngOnInit(): void {
    this.idx=this.routerx.snapshot.params
    this.id=this.idx.idx
    console.log('0000000000000',this.id)
    this._PurchaseOrder.getPurchaseOrderDetails(this.id).subscribe(Response=>
      {   
       ...
       console.log('0000000',this.purchaseOrderViewModel)
      })
